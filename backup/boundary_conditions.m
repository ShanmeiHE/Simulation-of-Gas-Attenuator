function [xn,yn,zn,rn,phin,vxn,vyn,vzn,vn,N_boundary] = boundary_conditions( x,y,z,r,phi,vx,vy,vz,v,dt,Rp,Lp,phimax,T0,m)
%rebound at boundary
N_boundary=0;
...
if length(ar)>0
    ...
    %fprintf('vi=%f\n',v(ar(1)));
    [vx(ar),vy(ar),vz(ar),x(ar),y(ar),z(ar)] = diffuse_scattering_xy(vx(ar),vy(ar),vz(ar) ...
  ,x(ar),y(ar),z(ar),Rp,dt,T0,m);  
...
azLp=find(z>Lp);
    ...
    %fprintf('vi=%f\n',v(a(1)));
    [vx(azLp),vy(azLp),vz(azLp),x(azLp),y(azLp),z(azLp)] = diffuse_scattering_z(vx(azLp),vy(azLp),vz(azLp) ...
    ,x(azLp),y(azLp),z(azLp),Lp,dt,T0,m);  
...
az0=find(z<0);
    ...
    [vx(az0),vy(az0),vz(az0),x(az0),y(az0),z(az0)] = diffuse_scattering_z(vx(az0),vy(az0),vz(az0) ...
    ,x(az0),y(az0),z(az0),Lp,dt,T0,m);  
